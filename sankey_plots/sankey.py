...
def sankey_new(left, right, leftWeight=None, rightWeight=None, colorDict=None,
    ...
    if colorDict is None:
        colorDict = {}
        orderedLabels = leftLabels + [label for label in rightLabels if label not in leftLabels]
        palette = "hls"
        colorPalette = sns.color_palette(palette, len(orderedLabels))
        for i, label in enumerate(orderedLabels):
